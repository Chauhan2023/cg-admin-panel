...
function AddShowcasebox() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosClients.post('/showcasebox', formDataToSubmit, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
      toast.success('Showcasebox created successfully.');
      navigate('/allshowcasebox');
    } catch (error) {
      toast.error('Error creating showcasebox.');
    } finally {
      setLoading(false);
    }
  };
